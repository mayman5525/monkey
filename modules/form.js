...
class FormModel {
  static async create({ name, phone_number, email }) {
    const query = `
      INSERT INTO forms (name, phone_number, email, created_at, updated_at)
      VALUES ($1, $2, $3, NOW(), NOW())
      RETURNING id, name, phone_number, email, created_at, updated_at
    `;
